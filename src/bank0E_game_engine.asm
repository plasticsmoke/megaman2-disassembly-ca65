...
clear_ram_loop:  sta     (temp_00),y        ; zero out RAM page
        ...
        cpx     #$08
        bne     clear_ram_loop
        lda     #$0E                    ; MMC1 control: PRG mode 3, vertical mirroring
...
game_init_refill:  ldx     #$0A    ; $8088 entry — refill all 11 weapon energies
        lda     #MAX_HP                    ; $1C = full weapon energy (28)
fill_weapon_ammo_loop:  sta     weapon_ammo,x
        dex
        bpl     fill_weapon_ammo_loop
game_init_checkpoint:  ldx     #$00
        lda     current_stage
        and     #$08
        beq     game_init_store_checkpoint
        ldx     #$03
game_init_store_checkpoint:  stx     checkpoint_idx ; Wily stages use checkpoint slots 3-5
                                        ; (checkpoint tables shared with paired RM stage)
        lda     #$14
        ldx     #$1F
game_init_fill_timers:  sta     ent_child_hp,x
        ...
        lda     #$00
        sta     boss_mode_flag
game_init_respawn:  lda     #$00        ; $80AB: respawn entry (keeps lives/ammo)
        sta     conveyor_face_l         ; conveyor facing constants read by
        lda     #$40                    ;   player_floor_tile_check (via $44+type)
        sta     conveyor_face_r
        lda     #$10
        sta     ppuctrl_shadow
        sta     PPUCTRL
...
main_loop_check_scroll:
        lda     frame_skip_lo           ; frame skip throttle (performance)
...
stage_intro_oam_data:  .byte   $60,$96,$01,$6C,$60,$97,$01,$74 ; "READY" text sprites
...
; =============================================================================
wily_spawn_gate_entities:  lda     boss_mode_flag
        cmp     #$FF
...
wily_spawn_check_done:  bcs     wily_spawn_next_bit
        ...
        ldx     temp_02
        jsr     spawn_entity_init
        lda     wily_gate_y_table,y
        sta     ent_y_spawn_px,y
        lda     wily_gate_x_table,y
...
wily_loop_check_scroll:  lda     frame_skip_lo
...
wily_gate_y_table:  .byte   $3B,$7B,$BB,$BB,$BB,$3B,$7B,$BB ; Y pixel position per gate
wily_gate_x_table:                       ; X pixel position per gate
...
check_vertical_transition:  lda     transition_type
        cmp     #$03                    ; transition_type $03 = fell into pit
...
; ─── Touch Wily gate ($7C): teleport into the boss chamber ───
wily_gate_enter_boss:
        jsr     wily_teleport_sequence
        lda     #$00
        sta     general_counter
        ldx     wily_stage_index
        lda     wily_gate_overlay_tbl,x
        sta     general_ptr_lo
        dex
        stx     current_stage
...
wily_gate_overlay_tbl:  rts             ; (rts byte doubles as unused entry 0)
        .byte   $06,$04,$0D,$07,$11,$09,$04,$10 ; CHR overlay/palette index per teleporter
...
wily_set_palette:
        ...
        ldx     boss_id
        clc
        lda     wily_gate_y_table,x
        adc     #$07
        sta     ent_y_px
        lda     wily_gate_x_table,x
        sta     ent_x_px
        jsr     reset_player_state
        lda     #$09
        jsr     sound_queue_push
...
; ─── Touch open Wily gate ($7E): teleport to the final corridor ───
wily_gate_enter_final:
        jsr     wily_teleport_sequence
        lda     #$29
        jsr     render_full_nametable
        lda     #$29
...
; Pickup handler per item type ($76-$7E). $76=lg health, $77=sm health,
; $78=lg weapon, $79=sm weapon, $7A=E-Tank, $7B=1UP, $7C-$7E=Wily gates.
item_handler_ptr_lo:
        .byte   <health_refill_large,<health_refill_small,<weapon_refill_large
        .byte   <weapon_refill_small,<etank_pickup,<extra_life_pickup
        .byte   <wily_gate_enter_boss,<wily_gate_mark_beaten,<wily_gate_enter_final
item_handler_ptr_hi:
        .byte   >health_refill_large,>health_refill_small,>weapon_refill_large
        .byte   >weapon_refill_small,>etank_pickup,>extra_life_pickup
        .byte   >wily_gate_enter_boss,>wily_gate_mark_beaten,>wily_gate_enter_final
...
; ─── Player state 0: teleport-in — wait for landing animation ───
player_state_teleport_in:  lda     ent_anim_id
        cmp     #$04
...
player_state_null:  rts                 ; state 1: inactive

; ─── Player state 2: hurt/knockback — no input, ride out recoil ───
player_state_hurt:
...
; ─── Player state 3: airborne (falling/knockback recovery) ───
player_state_air:  jsr     player_check_fire_weapon
...
player_state_common_exit:  lda     p1_new_presses
        ...
        lda     #$06
        sta     game_substate
player_state_set_weapon:  jsr     player_set_sprite
        rts

; ─── Player state 4: moving airborne ───
player_state_air_move:  jsr     player_check_fire_weapon
        jsr     player_update_facing
        jsr     player_set_max_speed
        jsr     player_horiz_movement
        jsr     player_vertical_physics
...
; ─── Player state 5: walking ───
player_state_walk:  jsr     player_check_fire_weapon
        jsr     player_update_facing
        jsr     player_set_max_speed
        jsr     player_horiz_movement
        jsr     player_vertical_physics
...
; ─── Player state 6: standing/idle — decelerate, handle conveyors ───
player_state_idle:  jsr     player_check_fire_weapon
        lda     #$00
...
player_state_climb_set_weapon:  jsr     player_set_sprite
        rts

; ─── Player states 7/8: running ───
player_state_run:  jsr     player_check_fire_weapon
        jsr     player_update_facing
        jsr     player_set_max_speed
        jsr     player_horiz_movement
        jsr     player_vertical_physics
...
player_ladder_check_left:  and     #$08
        ...
        sta     game_substate
        bne     player_ladder_check_solid
player_ladder_move_down:  lda     is_on_ground
        cmp     #$01
...
player_ladder_set_vel:  ldy     #$FF
        ...
        lda     #$0A
        sta     game_substate
player_ladder_check_solid:  lda     weapon_fire_dir
...
player_ladder_clear_vel:  lda     #$00
        sta     ent_anim_frame
player_ladder_exit:  jsr     player_set_sprite
        rts
...
; =============================================================================
; States: 0=teleport-in 1=null 2=hurt 3=air 4=air-move 5=walk 6=idle
;         7/8=run 9/A=ladder B=anim-clear (Wily teleport)
player_state_ptr_lo:
        .byte   <player_state_teleport_in,<player_state_null,<player_state_hurt
        .byte   <player_state_air,<player_state_air_move,<player_state_walk
        .byte   <player_state_idle,<player_state_run,<player_state_run
        .byte   <player_state_ladder_idle,<player_state_ladder_idle,<player_ladder_clear_anim
player_state_ptr_hi:
        .byte   >player_state_teleport_in,>player_state_null,>player_state_hurt
        .byte   >player_state_air,>player_state_air_move,>player_state_walk
        .byte   >player_state_idle,>player_state_run,>player_state_run
...
player_check_ladder_rts:  lda     is_on_ground
...
player_set_max_speed:  ldx     game_substate      ; player state index for speed table
        ...
        sta     ent_x_vel_sub
        sta     ent_x_vel
player_check_accel_start:  lda     conveyor_type
...
player_store_max_speed:  lda     max_speed_sub
        sta     ent_x_vel_sub
        lda     max_speed_hi
        sta     ent_x_vel
...
player_set_face_dir:  lda     ent_flags
        and     #$40
        sta     scroll_dir_flags
player_handle_conveyor:  lda     conveyor_type
...
player_no_conveyor:  lda     max_speed_hi
        ora     max_speed_sub
...
tile_check_loop:  ldx     temp_01
        ...
        sta     temp_00
        ldx     #$02
tile_eval_loop:  ldy     floor_tile_type,x
...
ground_check_lava:  lda     floor_tile_type + 1
        cmp     #$04
        ...
        and     #$F0
        sta     ent_y_px + $0E
ground_spawn_item:  inc     column_attr_byte
...
ground_spawn_random_item:  lda     player_y_screen
...
ground_store_params:  lda     gravity_hi_table,x
        ...
        sta     temp_01
        ldx     #$02
ground_calc_platform_dir:  lda     floor_tile_type,x
        cmp     #$02
...
ground_check_above:  clc
        ...
        lda     player_y_screen
        adc     #$00
ground_store_above:  sta     temp_0B
        jsr     lookup_tile_from_map
        lda     temp_00
        cmp     #$02
...
ground_store_dir:  ora     is_on_ground
        sta     is_on_ground
...
player_apply_gravity:
        ...
        sta     ent_y_px
        tax
        lda     player_y_screen         ; extend subtraction to page byte
        sbc     temp_00
        sta     player_y_screen
...
floor_tile_loop:  ldx     temp_01
        ...
        sta     conveyor_type
        ldx     #$01
floor_tile_eval:  lda     floor_tile_type,x
        cmp     #$08
...
platform_check_y:  lda     player_y_screen
...
platform_check_secondary:  lda     player_y_screen
...
transition_right_col_step:  lda     general_counter
        and     #$07                    ; every 8th column: render metatile attributes
...
transition_scroll_frame_loop:  tya
        ...
        jsr     vert_scroll_update_entity ; keep Atomic Fire charge (slot 2) on player
...
; ─── Keep the slot-2 weapon entity (Atomic Fire charge) on the player ───
...
reset_entity_slots:  ldx     #$00
        lda     current_weapon
        cmp     #$06                    ; Time Stopper: freeze entity lives in slot 2
        beq     reset_entity_save_boss
        cmp     #$01                    ; Atomic Fire: charge entity lives in slot 2
...
shrink_ai_preamble:
        cpx     #$04
        bne     shrink_update_timer
        sta     ent_anim_frame,x
        lda     ent_parent_slot,x
        bne     shrink_reset_state

; =============================================================================
; shrink_lunge_start -- Enemy AI: Met (Hard Hat) — hide/shoot pattern ($949A)
; =============================================================================
shrink_lunge_start:
        lda     #$01
        ...
        ldx     current_entity_slot
        jmp     shrink_update_timer

shrink_calc_aim:  jsr     entity_face_player
        lda     $DA01
        sta     ent_x_vel,x
        lda     $DA02
        sta     ent_x_vel_sub,x
...
shrink_reset_state:
        ...
        lda     #$FF
        sta     ent_y_vel,x
shrink_update_timer:  dec     ent_state,x
        lda     ent_anim_id,x
        cmp     #$04
        bcc     shrink_apply_physics
        bne     shrink_check_anim_7
        lda     #$00
        sta     ent_anim_id,x
        beq     shrink_apply_physics
shrink_check_anim_7:  cmp     #$07
        bne     shrink_apply_physics
        lda     #$00
        sta     ent_anim_frame,x
shrink_apply_physics:  jsr     apply_entity_physics
        rts

shrink_delay_table:  .byte   $19,$4A                         ; Met hide/shoot delay timings
...
; ─── Anko sub-part AI (type $10) — timed animation, simple physics ───
anko_10_ai:  lda     ent_state,x
        bne     anko_10_check_anim
        lda     #$01
        sta     ent_anim_id,x
        lda     #$70
        sta     ent_state,x
anko_10_check_anim:  lda     ent_anim_id,x
        cmp     #$04
        bcc     anko_10_update
        lda     #$00
        sta     ent_anim_frame,x
anko_10_update:  dec     ent_state,x
        jsr     apply_simple_physics
        rts
...
rail_platform_ai:
        ...
        ldy     current_stage
        cpy     #$07
        beq     rail_platform_store_pos
        sec
        lda     ent_x_screen,x
        sbc     #$1B
rail_platform_store_pos:
        sta     temp_00
        tay
        lda     rail_platform_path_offset_table,y
        sta     temp_01
        clc
        adc     ent_state,x
        tay
        lda     temp_00
        cmp     #$03
        bcs     rail_platform_path_wily
        lda     rail_platform_path_data,y
        sta     temp_02
        lda     rail_platform_path_entry,y
        jmp     rail_platform_check_axis

; =============================================================================
; rail_platform_path_wily -- Rail Platform — Wily stage pathfinding ($9AA8)
; =============================================================================
rail_platform_path_wily:  lda     rail_platform_wily_path_data,y
        sta     temp_02
        lda     rail_platform_wily_path_entry,y
rail_platform_check_axis:  and     #$01
        bne     rail_platform_check_x
        lda     ent_y_px,x
        cmp     temp_02
        beq     rail_platform_at_target
        bne     rail_platform_get_direction
rail_platform_check_x:  lda     ent_x_px,x
        cmp     temp_02
        bne     rail_platform_get_direction
rail_platform_at_target:  lda     #$00
        sta     ent_x_sub,x
        sta     ent_y_sub,x
        iny
        iny
        ...
        lda     ent_state,x
        ldx     temp_00
        cmp     rail_platform_path_len_table,x
        bne     rail_platform_get_direction
        ldx     current_entity_slot
        lda     #$00
        sta     ent_state,x
        ldy     temp_01
rail_platform_get_direction:  ldx     temp_00
        cpx     #$03
        bcs     rail_platform_get_direction_wily
        lda     rail_platform_path_entry,y
        jmp     rail_platform_set_velocity

rail_platform_get_direction_wily:  lda     rail_platform_wily_path_entry,y
rail_platform_set_velocity:  ldx     current_entity_slot
        tay
        lda     rail_platform_vel_y_sub_table,y
        sta     ent_y_vel_sub,x
        lda     rail_platform_vel_y_table,y
        sta     ent_y_vel,x
        lda     rail_platform_vel_x_sub_table,y
        sta     ent_x_vel_sub,x
        lda     rail_platform_flags_table,y
        sta     ent_flags,x
        jsr     apply_entity_physics
        bcc     rail_platform_set_hitbox
        lda     #$00
        sta     ent_plat_height,x
rail_platform_set_hitbox:  sec
        lda     ent_y_px,x
        sbc     #$04
        sta     ent_plat_y,x
        rts

rail_platform_path_offset_table:  .byte   $00,$08,$24,$00,$44,$5C,$8C
rail_platform_vel_y_sub_table:  .byte   $1B,$00,$E5,$00
rail_platform_vel_y_table:  .byte   $FF,$00,$00,$00
rail_platform_vel_x_sub_table:  .byte   $00,$E5,$00,$E5
rail_platform_flags_table:  .byte   $80,$80,$C0,$C0
rail_platform_path_len_table:  .byte   $08,$1C,$54,$44,$18,$30,$14
rail_platform_path_data:                      ; Rail Platform movement path coordinate data
        .byte   $A0                       ; path header
rail_platform_path_entry:
...
rail_platform_wily_path_data:                 ; Rail Platform Wily stage path data
        .byte   $A0                       ; path header
rail_platform_wily_path_entry:
...
; ─── Crumble Block AI (type $13) — rideable platform that falls when stepped on ───
crumble_block_ai:  lda     #$18
        sta     ent_plat_height,x
        lda     ent_flags,x
        and     #$04
        bne     crumble_block_falling
        lda     ent_state,x
        cmp     #$06
        bcs     crumble_block_falling
        jsr     apply_entity_physics_alt
        jmp     crumble_block_physics

; =============================================================================
; crumble_block_falling -- Crumble Block — platform drops after being stood on ($9C74)
; =============================================================================
crumble_block_falling:  lda     ent_flags,x
        ora     #$04
        sta     ent_flags,x
        jsr     apply_entity_physics
crumble_block_physics:  bcc     crumble_block_hitbox
        lda     #$00
        sta     ent_plat_height,x
crumble_block_hitbox:  sec
        lda     ent_y_px,x
        sbc     #$08
        sta     ent_plat_y,x
        rts

; ─── Laser spawner AI (type $14) — spawns beam segments ($15) from per-screen tables ───
laser_beam_ai:
        sec
        lda     ent_x_screen,x
        sbc     #$03
        tay
        lda     laser_beam_blade_count_table,y
        sta     temp_02
        lda     laser_beam_blade_src_table,y
        sta     temp_01
laser_beam_spawn_blade:  lda     #ENTITY_LASER_SEG
        jsr     spawn_entity_from_parent
        ldx     temp_01
        lda     laser_beam_blade_flags,x
        sta     ent_spawn_flags,y
        and     #$40
        bne     laser_beam_blade_offset
        lda     #$FC
        bne     laser_beam_blade_set_x
laser_beam_blade_offset:  lda     #$04
laser_beam_blade_set_x:  sta     ent_x_spawn_px,y
        lda     laser_beam_blade_y_table,x
        sta     ent_y_spawn_px,y
        lda     laser_beam_blade_range,x
        sta     ent_despawn,y
        lda     laser_beam_blade_timer_table,x
        sta     ent_drop_flag,y
        ldx     current_entity_slot
        inc     temp_01
        dec     temp_02
        bne     laser_beam_spawn_blade
        lsr     ent_flags,x
        lda     #$00
        sta     a:$F0,x
        rts

laser_beam_blade_count_table:
        .byte   $02,$03,$04,$00,$00,$00,$00,$00
        .byte   $00,$0C,$0A,$05,$05,$02,$05,$04
laser_beam_blade_src_table:  .byte   $00,$02,$05,$09,$09,$09,$09,$09 ; Metal Blade source position table
        .byte   $09,$09,$15,$1F,$24,$29,$2B,$30
laser_beam_blade_flags:                    ; entity flags per blade direction (52 entries)
        ...
        .byte   $A1,$A1,$E1,$A1
laser_beam_blade_y_table:  .byte   $47
        ...
        .byte   $27,$67,$A7
laser_beam_blade_range:                    ; distance range per throw direction (52 entries)
        ...
        .byte   $00,$00,$FF,$20
laser_beam_blade_timer_table:              ; frame timing per throw pattern (52 entries)
        ...
        .byte   $01,$1F,$3E,$5D
; --- laser_seg_ai -- Laser beam segment (type $15) — Quick Man stage force beam.
; Extends toward target X drawing BG tiles ($74/$76); instant-kills on contact. ---
laser_seg_ai:
        lda     ent_state,x
        beq     laser_seg_timer_expired
        dec     ent_state,x
        beq     laser_seg_timer_just_zero
        rts
laser_seg_timer_just_zero:
        lda     ent_flags,x
        and     #$DF
        sta     ent_flags,x
        lda     #$27
        jsr     sound_queue_push
laser_seg_timer_expired:
        lda     ent_flags,x
        and     #$20
        bne     laser_seg_check_contact
        lda     ent_flags,x
        and     #$40
        bne     laser_seg_check_extend
        lda     ent_x_px,x
        cmp     ent_parent_slot,x
        bcs     laser_seg_draw_step
        bcc     laser_seg_at_target_x

; =============================================================================
; laser_seg_check_extend -- Laser segment — extend across screen, draw BG tiles ($9DFE)
; =============================================================================
laser_seg_check_extend:  lda     ent_x_px,x
        cmp     ent_parent_slot,x
        bcc     laser_seg_draw_step
laser_seg_at_target_x:  lda     ent_parent_slot,x
        sta     ent_x_px,x
        lda     ent_flags,x
        ora     #$20
        sta     ent_flags,x
        bne     laser_seg_check_contact
laser_seg_draw_step:  lda     ent_x_screen,x
        sta     jump_ptr_hi
        lda     ent_x_px,x
        sta     jump_ptr
        lda     ent_y_px,x
        ...
        and     #$01
        beq     laser_seg_set_tile
        ldy     #$76
laser_seg_set_tile:  tya
        sta     col_update_tiles + $0A,x
        inc     attr_update_count
        ldx     current_entity_slot
        jsr     apply_entity_physics
        bcc     laser_seg_check_contact
        lda     ent_flags,x
        asl     a
        ora     #$20
        sta     ent_flags,x
laser_seg_check_contact:  lda     invincibility_timer
        bne     laser_seg_rts
        sec
        lda     ent_y_px,x
        sbc     ent_y_px
        bcs     laser_seg_check_y_range
        eor     #$FF
        adc     #$01
laser_seg_check_y_range:  cmp     #$10
        bcs     laser_seg_rts
        lda     ent_flags,x
        and     #$40
        bne     laser_seg_facing_left
        lda     ent_x_px,x
        cmp     ent_x_px
        bcs     laser_seg_rts
        bcc     laser_seg_kill_player
laser_seg_facing_left:  lda     ent_x_px,x
        cmp     ent_x_px
        bcc     laser_seg_rts
laser_seg_kill_player:  lda     #$00
        sta     game_substate
        jmp     player_death_sequence

laser_seg_rts:  rts

; --- batton_ai -- Batton bat (type $16) — hang on timer, then swoop at player ---
batton_ai:
        lda     ent_state,x
        bne     batton_check_state
        lda     rng_seed
        eor     #$01
        sta     rng_seed
        and     #$01
        tay
        lda     batton_timer_table,y
        sta     ent_state,x
        lda     #$8B
        sta     ent_flags,x
        bne     batton_apply_physics
batton_check_state:
        cmp     #$01
        beq     batton_swoop
        cmp     #$FF
        ...
        sta     ent_anim_id,x
        sta     ent_anim_frame,x
batton_apply_physics:
        jsr     apply_entity_physics_alt
        rts

; =============================================================================
; batton_swoop -- Batton — unfold and swoop toward the player ($9EB3)
; =============================================================================
batton_swoop:  lda     ent_flags,x
        and     #$F7
        sta     ent_flags,x
        lda     ent_anim_id,x
        cmp     #$08
        bne     batton_swoop_physics
        lda     #$05
        sta     ent_anim_id,x
        lda     #$00
        sta     jump_ptr_hi
        ...
        sta     jump_ptr
        jsr     calc_entity_velocity
batton_swoop_physics:  jsr     apply_entity_physics
        lda     temp_01
        beq     batton_swoop_rts
        lda     #$00
        sta     ent_x_vel,x
        sta     ent_x_vel_sub,x
        sta     ent_y_vel_sub,x
        ...
        lda     #$FF
        sta     ent_state,x
batton_swoop_rts:  rts

batton_land:  lda     ent_anim_id,x
        cmp     #$08
        bne     batton_land_setup
        lda     #$05
        sta     ent_anim_id,x
batton_land_setup:  lda     #$04
        sta     temp_01
        lda     #$08
        sta     temp_02
        jsr     check_vert_tile_collision
        lda     temp_00
        beq     batton_land_physics
        lda     #$00
        sta     ent_y_vel,x
        sta     ent_y_vel_sub,x
        lda     #$8B
        ...
        lda     #$3E
        sta     ent_state,x
batton_land_physics:  jsr     apply_entity_physics
        rts

batton_timer_table:  .byte   $3E,$9C         ; Bubble Man AI timer values (62/156 frames)
; --- robbit_ai -- Robbit (type $17) — hopping rabbit, fires aimed shots ---
robbit_ai:
        lda     ent_y_vel,x
        sta     temp_04
        lda     #$0C
        ...
        jsr     check_horiz_tile_collision
        lda     ent_parent_slot,x
        bne     robbit_check_pattern
        lda     ent_state,x
        bne     robbit_dec_timer
        lda     #$C0
        sta     ent_x_vel_sub,x
        sta     ent_y_vel_sub,x
        lda     #$04
        ...
        lda     #$01
        sta     ent_anim_id,x
robbit_check_pattern:
        lda     ent_parent_slot,x
        cmp     #$01
        bne     robbit_check_timer
        lda     temp_04
        bpl     robbit_dec_timer
        lda     temp_00
        beq     robbit_dec_timer
        lda     #$00
        sta     ent_x_vel_sub,x
        inc     ent_parent_slot,x
        lda     #$3E
...
; =============================================================================
; robbit_check_timer -- Robbit — fire aimed carrot shot (type $18) on timer ($9F79)
; =============================================================================
robbit_check_timer:  lda     ent_state,x
        bne     robbit_dec_timer
        jsr     entity_face_player
        lda     #ENTITY_ROBBIT_SHOT      ; spawn aimed carrot shot
        jsr     spawn_entity_from_parent
        bcs     robbit_set_timer
...
robbit_set_timer:  lda     #$3E
        ...
        lda     #$00
        sta     ent_parent_slot,x
robbit_dec_timer:  dec     ent_state,x
        ldy     ent_parent_slot,x
        lda     ent_anim_id,x
        cmp     robbit_anim_threshold,y
        bne     robbit_physics
        lda     #$00
        sta     ent_anim_frame,x
robbit_physics:  jsr     apply_entity_physics
        rts

robbit_anim_threshold:  .byte   $00,$02,$00,$00,$00             ; Quick Man animation speed thresholds
; ─── Friender flame AI (types $19/$1A) — flame wall + fire bursts ───
friender_flame_ai:
        ldy     #$02
        lda     ent_hp,x
        bne     friender_flame_palette_check
        jmp     friender_flame_burst_entry
friender_flame_palette_check:
        cmp     ent_y_vel_sub,x
        beq     friender_flame_palette_set
        ldy     #$05
friender_flame_palette_set:  sta     ent_y_vel_sub,x
        ldx     #$0F
friender_flame_palette_loop:  lda     friender_flame_palette_data,y
        sta     palette_ram,x
        dey
        dex
        cpx     #$0C
        bne     friender_flame_palette_loop
        ldx     current_entity_slot
        lda     ent_x_vel_sub,x
        bne     friender_flame_check_state
        lda     #$01
        sta     ent_anim_id,x
        lda     #$00
        sta     ent_anim_frame,x
        lda     ent_state,x
        bne     friender_flame_dec_timer
        lda     #ENTITY_FIREBALL     ; spawn arcing fireball
        jsr     spawn_entity_from_parent
        bcs     friender_flame_spawned
        clc
...
; =============================================================================
; friender_flame_spawned -- Friender flame — burst pattern, fireball spawning ($A019)
; Spawns entity $1B (arcing fireball).
; =============================================================================
friender_flame_spawned:  lda     #$02
        sta     ent_state,x
        dec     ent_x_vel,x
        bne     friender_flame_physics
        inc     ent_x_vel_sub,x
        bne     friender_flame_physics
friender_flame_dec_timer:  dec     ent_state,x
friender_flame_check_state:  lda     ent_anim_id,x
        bne     friender_flame_physics
        lda     #$00
        sta     ent_x_vel_sub,x
        lda     #$03
        ...
        adc     #$03
        sta     ent_x_vel,x
friender_flame_physics:  jsr     apply_entity_physics_alt
        bcc     friender_flame_rts
        lda     #$80
        sta     ent_flags,x
        lda     #ENTITY_FIRE_PROJ_A    ; convert self to secondary flame
        sta     ent_type,x
        lda     #$00
        sta     ent_state,x
        sta     ent_x_vel_sub,x
        sta     ent_hit_count,x
friender_flame_rts:  rts

friender_flame_burst_entry:
        lda     #$00
        sta     ent_anim_id,x
        sta     ent_anim_frame,x
        lda     ent_x_vel_sub,x
        beq     friender_flame_pattern
        jmp     friender_flame_dec_cooldown

friender_flame_pattern:  lda     ent_state,x
        and     #$03
        sta     temp_00
        asl     a
        asl     a
        ...
        lda     #$05
        sta     temp_02
friender_flame_loop:  lda     #ENTITY_DEATH_EXPLODE
        jsr     spawn_entity_from_parent
        bcs     friender_flame_done
        ldx     temp_01
        clc
        lda     ent_x_spawn_px,y
        adc     friender_flame_x_offset,y
        sta     ent_x_spawn_px,y
        clc
        lda     ent_y_spawn_px,y
        adc     friender_flame_y_offset,y
        sta     ent_y_spawn_px,y
        .byte   $E6                      ; code: INC $01 (advance flame slot)
friender_flame_inc:  .byte   $01,$C6,$02  ; dual-use: data table AND code (DEC $02)
        bne     friender_flame_loop
friender_flame_done:  ldx     current_entity_slot
        inc     ent_state,x
        lda     ent_state,x
        cmp     #$08
        bne     friender_flame_set_cooldown
        lda     #$1A
        jsr     find_entity_by_type
        bcs     friender_flame_kill_parent
        lda     #$00
        sta     ent_spawn_flags,y
        lda     #$FF
        sta     ent_hit_count,y
friender_flame_kill_parent:  lda     #$1C
        jsr     find_entity_by_type
        bcs     friender_flame_kill_fire
        lda     #$FF
        sta     ent_drop_flag,y
friender_flame_kill_fire:  lda     #$2E
        jsr     find_entity_by_type
        bcs     friender_flame_kill_done
        lda     #$00
        sta     ent_spawn_flags,y
        lda     #$FF
        ...
        lda     #$00
        sta     ent_child_hp,y
        beq     friender_flame_kill_fire
friender_flame_kill_done:  sta     a:$F0,x
        asl     ent_flags,x
friender_flame_set_cooldown:  lda     #$08
        sta     ent_x_vel_sub,x
friender_flame_dec_cooldown:  dec     ent_x_vel_sub,x
        rts

friender_flame_palette_data:                    ; Heat Man intro palette (6 bytes)
        .byte   $08,$2C,$12,$08,$20,$20
friender_flame_x_offset:  .byte   $FC    ; Heat Man flame X offset per slot
        .byte   $FC,$14,$1C,$2C,$F4,$04,$0C,$14
        .byte   $24,$F4,$04,$14,$2C,$2C,$04,$0C
friender_flame_x_off_end:  .byte   $14,$24,$24
friender_flame_y_offset:                  ; Heat Man flame Y pixel offsets (11 entries)
        .byte   $F8,$10,$08,$F0,$F8,$00,$E8,$10
        .byte   $F8,$08,$08
friender_flame_y_off_2:                  ; Heat Man flame Y offsets continued (9 entries)
        .byte   $F8,$00,$E8,$08,$00,$E8,$F8,$F0
        .byte   $08
        ; Friender flame #2 (type $1A): timed fade, simple physics
        lda     ent_state,x
        bne     friender_flame2_check_state
        lda     #$6E
        sta     ent_state,x
        lda     #$01
        sta     ent_anim_id,x
friender_flame2_check_state:
        lda     ent_anim_id,x
        bne     friender_flame2_dec_timer
        sta     ent_anim_frame,x

; =============================================================================
; friender_flame2_dec_timer -- Friender flame #2 (type $1A) — timer decrement ($A14D)
; =============================================================================
friender_flame2_dec_timer:  dec     ent_state,x
        jsr     apply_entity_physics_alt
        rts

; ─── Fireball AI (type $1B) — arcing flame with gravity ───
fireball_ai:
        clc
        lda     ent_y_vel_sub,x
        adc     #$40
...
friender_ai:
        ...
        sbc     #$06
        tay
        lda     friender_height_threshold,y
        cmp     ent_y_px,x
        beq     friender_landing_reached
        lda     ent_flags,x
        and     #$DF
        sta     ent_flags,x
        lda     #$00
...
friender_landing_reached:
        ...
        clc
        lda     ent_y_px,x
        adc     friender_y_offset_table,y
        and     #$E0
        sta     temp_0A
        clc
        lda     ent_x_px,x
        adc     friender_x_offset_table,y
        and     #$E0
        sta     jump_ptr
        lda     ent_x_screen,x
        sta     jump_ptr_hi
        ...
        lda     ent_state,x
        cmp     #$FF
        bne     friender_set_tile_pattern
        clc
        lda     temp_00
        adc     #$04
        sta     temp_00
friender_set_tile_pattern:  lda     temp_00
        asl     a
        asl     a
        asl     a
        asl     a
        ...
        lda     #$10
        sta     temp_00
friender_copy_tiles:  lda     friender_tile_data,x
        sta     ppu_update_buf + $10,y
        inx
        iny
        dec     temp_00
        bne     friender_copy_tiles
        ...
        lda     ent_state,x
        bne     friender_rts
        lda     #ENTITY_FIRE_PROJ_A    ; spawn Air Shooter tornado (primary)
        jsr     spawn_entity_from_parent
        lda     #$08
        sta     ent_drop_flag,y
        lda     #$03
        ...
        pla
        and     #$01
        bne     friender_spawn_fire
        clc
        lda     ent_hitbox_w_lo,y
        adc     #$03
        sta     ent_hitbox_w_lo,y
friender_spawn_fire:  lda     #ENTITY_FIRE_PROJ_B    ; spawn Air Shooter tornado (secondary)
        jsr     spawn_entity_from_parent
        clc
        lda     ent_x_spawn_px,y
        adc     #$2F
...
friender_height_threshold:
        .byte   $88,$68,$48
friender_y_offset_table:
...
friender_tile_data:                         ; 128 bytes — CHR tile indices for Friender sprite
        ...
        .byte   $84,$86,$84,$86,$85,$87,$85,$87
        .byte   $84,$86,$84,$86,$85,$87,$85,$87
; ─── Monking AI (type $1D) — ceiling monkey: drop, hop, pounce at player ───
monking_ai:  jsr     entity_face_player
        lda     ent_flags,x
        and     #$20
        beq     monking_check_anim
        lda     temp_00
        cmp     #$50
        bcc     monking_drop_start
        jsr     apply_entity_physics_alt
        rts

; =============================================================================
; monking_drop_start -- Monking — drop from ceiling, pounce pattern ($A308)
; =============================================================================
monking_drop_start:  lda     #$00
        sta     ent_anim_id,x
        sta     ent_anim_frame,x
        lda     ent_flags,x
        and     #$DF
        ...
        lda     #$04
        sta     ent_y_vel,x
monking_check_anim:  lda     ent_anim_id,x
        bne     monking_check_pounce
        lda     #$00
        sta     ent_anim_frame,x
        lda     #$07
        sta     temp_01
        ...
        jsr     check_vert_tile_collision
        lda     temp_00
        bne     monking_land_stop
        jmp     monking_physics

monking_land_stop:  lda     #$00
        sta     ent_y_vel,x
        inc     ent_anim_id,x
        jmp     monking_physics

monking_check_pounce:  lda     ent_anim_id,x
        cmp     #$02
        bne     monking_check_height
        clc
        lda     ent_y_px,x
        adc     #$05
        sta     ent_y_px,x
        inc     ent_anim_id,x
monking_check_height:  lda     ent_anim_id,x
        cmp     #$08
        bcs     monking_state_air
        lda     temp_00
        cmp     #$20
        bcc     monking_jump
        inc     ent_state,x
...
monking_state_air:  lda     #$08
        ...
        inc     ent_anim_id,x
        bne     monking_physics
monking_state_land:  lda     temp_00
        beq     monking_physics
        lda     #$08
        sta     ent_anim_id,x
        lda     #$32
        ...
        sta     ent_x_vel_sub,x
        sta     ent_x_vel,x
monking_physics:  jsr     apply_entity_physics
        rts
...
telly_spawn_ai:
        lda     ent_state,x
        bne     telly_spawn_dec_timer
        lda     #$03
        sta     temp_01
        lda     #ENTITY_TELLY
        jsr     find_entity_count_check
        bcs     telly_spawn_store_timer
        lda     #ENTITY_TELLY
        jsr     spawn_entity_from_parent
telly_spawn_store_timer:
        lda     #$DA
        sta     ent_state,x
telly_spawn_dec_timer:
        dec     ent_state,x
        jsr     apply_entity_physics_alt
        rts
...
telly_ai:
        ...
        lda     #$10
        sta     ent_state,x
telly_dec_timer:  dec     ent_state,x
        jsr     apply_entity_physics
        rts
...
changkey_ai:
        ...
        lda     #$83
        sta     ent_flags,x
        bcs     changkey_dec_timer
        lda     #ENTITY_LIGHT_RESTORE
        jsr     spawn_entity_from_parent
        jmp     changkey_dec_timer
changkey_check_timer:
        lda     ent_state,x
        beq     changkey_check_anim
        lda     ent_anim_id,x
        cmp     #$02
        bne     changkey_dec_timer
        lda     #$00
        sta     ent_anim_id,x
        beq     changkey_dec_timer
changkey_check_anim:  lda     ent_anim_id,x
        cmp     #$04
        bne     changkey_physics
        lda     ent_anim_frame,x
        bne     changkey_physics
        jsr     entity_face_player
        lda     #ENTITY_CHANGKEY_PROJ
        jsr     spawn_entity_from_parent
        bcs     changkey_random_timer
        sec
        lda     rng_seed
        and     #$1F
        sta     rng_seed
        ...
        lda     temp_00
        sta     ent_hitbox_w_hi,y
changkey_random_timer:  lda     rng_seed
        and     #$03
        tay
        lda     changkey_timer_table,y
        sta     ent_state,x
changkey_dec_timer:  dec     ent_state,x
changkey_physics:  jsr     apply_entity_physics_alt
        bcc     changkey_rts
        lda     #ENTITY_CHANGKEY
        jsr     find_entity_by_type
        bcc     changkey_rts
...
changkey_timer_table:  .byte   $12,$1F,$1F,$3D             ; random timer values for boss AI
...
blackout_trigger_ai:
        ...
        bcc     blackout_trigger_ai_done
        lda     ent_state,x
        bne     blackout_dec_timer
        lda     ent_x_vel_sub,x

; =============================================================================
; blackout_palette_set -- Boss Palette Flash — cycle palette during death/hit animation ($A577)
; =============================================================================
blackout_palette_set:  asl     a
        asl     a
        sta     temp_00
        asl     a
        clc
        ...
        tax
        ldy     #$00
blackout_palette_loop:  lda     blackout_palette_data,x
        sta     palette_ram,y
        inx
        iny
        cpy     #$0C
        bne     blackout_palette_loop
        ldx     current_entity_slot
        inc     ent_x_vel_sub,x
        lda     ent_x_vel_sub,x
        cmp     #$04
blackout_trigger_ai_done:
        bne     blackout_set_timer
        lsr     ent_flags,x
        lda     #$FF
        sta     a:$F0,x
blackout_set_timer:  lda     #$08
        sta     ent_state,x
blackout_dec_timer:  dec     ent_state,x
        rts

; ─── Light restore AI (type $26) — step palette back toward lit ───
light_restore_ai:  lda     ent_state,x
        bne     blackout_dec_timer
        clc
        lda     ent_x_vel_sub,x
        adc     #$03
        bne     blackout_palette_set

; ─── Blackout zone end AI (type $27) — reverse palette step ───
blackout_end_ai:  lda     ent_state,x
        bne     blackout_dec_timer
        lda     ent_x_vel_sub,x
        eor     #$03
        jmp     blackout_palette_set
...
blackout_restore_ai:
        ...
        adc     #$03
        jmp     blackout_palette_set
blackout_palette_data:  .byte   $0F,$2C,$10,$1C,$0F,$37,$27,$07 ; palette flash color cycle data
...
; =============================================================================
; gear_physics -- Gear AI (entity $29) — shared physics ($A653)
; =============================================================================
gear_physics:  jsr     apply_entity_physics_alt
        rts
...
; =============================================================================
; gear_attack -- Gear AI (entity $29) — Pierrobot attack, collision, bounce ($A689)
; =============================================================================
gear_attack:  sec
        lda     ent_y_px,x
        sbc     #$20
...
gear_collision:  lda     #$0F
        ...
        lda     ent_state,x
        cmp     #$04
        bne     gear_check_bounce
        lda     temp_00
        beq     gear_check_bounce
        jsr     entity_face_player
        lda     #$47
        sta     ent_x_vel_sub,x
        lda     #$01
        sta     ent_x_vel,x
        inc     ent_state,x
gear_check_bounce:  lda     temp_03
        beq     gear_apply_physics
        lda     ent_flags,x
        eor     #$40
        sta     ent_flags,x
gear_apply_physics:  jsr     apply_entity_physics
        bcc     gear_rts
        ldy     ent_parent_slot,x
        cpy     #$FF
        beq     gear_rts
...
fly_boy_spawn_ai:
        lda     ent_state,x
        bne     fly_boy_spawn_dec_timer
        lda     #$02
        sta     temp_01
        lda     #ENTITY_FLY_BOY
        jsr     find_entity_count_check
        bcs     fly_boy_spawn_set_timer
        lda     #ENTITY_FLY_BOY
        jsr     spawn_entity_from_parent
fly_boy_spawn_set_timer:
        lda     #$7D
        sta     ent_state,x
fly_boy_spawn_dec_timer:
        dec     ent_state,x
        jsr     apply_entity_physics_alt
        rts
...
fly_boy_ai:
        lda     ent_parent_slot,x
        bne     fly_boy_phase_check
        inc     ent_parent_slot,x
fly_boy_phase_check:
        lda     ent_parent_slot,x
        cmp     #$02
        bcs     fly_boy_check_bite_state
        lda     #$00
        sta     ent_anim_id,x
        sta     ent_anim_frame,x
        lda     #$08
        ...
        sta     ent_flags,x
        inc     ent_parent_slot,x
fly_boy_check_bite_state:  lda     ent_parent_slot,x
        cmp     #$02
        bne     fly_boy_check_anim
        lda     ent_anim_id,x
        cmp     #$09
        bne     fly_boy_physics
        lda     #$E5
        ...
        sta     ent_state,x
        inc     ent_parent_slot,x
fly_boy_check_anim:  lda     ent_anim_id,x
        cmp     #$0B
        bne     fly_boy_dec_timer
        lda     #$09
        sta     ent_anim_id,x
fly_boy_dec_timer:  dec     ent_state,x
        bne     fly_boy_physics
        lda     #$87
        sta     ent_flags,x
        jsr     entity_face_player
        ...
        lda     #$01
        sta     ent_parent_slot,x
fly_boy_physics:  jsr     apply_entity_physics
        rts
...
press_ai:
        lda     ent_parent_slot,x
        bne     press_tile_check
        jsr     entity_face_player
        lda     temp_00
        cmp     #$28
        bcs     press_apply_physics
        lda     #$87
        sta     ent_flags,x
        lda     #$FF
        sta     ent_y_vel,x
...
press_tile_check:
        ...
        sta     ent_drop_flag,y
        bne     press_physics
press_check_landed:  lda     ent_state,x
        beq     press_check_wall
        dec     ent_state,x
        bne     press_physics
        lda     #$00
        sta     ent_y_vel,x
        ...
        sta     ent_flags,x
        bne     press_physics
press_check_wall:  lda     temp_00
        beq     press_physics
        lda     #$00
        sta     ent_y_vel_sub,x
        sta     ent_parent_slot,x
press_physics:  jsr     apply_entity_physics
        rts

; =============================================================================
; blocky_fire -- Blocky AI (entity $31) — fire breath, walk, debris spawn ($A877)
...
blocky_fire:  lda     #$07
        ...
        lda     ent_anim_id,x
        cmp     #$0F
        bne     blocky_check_timer
        lda     #$0E
        sta     ent_anim_id,x
blocky_check_timer:  lda     ent_state,x
        beq     blocky_check_state
        dec     ent_state,x
        bne     blocky_check_state
        lda     #$02
        sta     temp_01
blocky_spawn_fire:  lda     #ENTITY_MECHA_FIRE
        jsr     spawn_entity_from_parent
        bcs     blocky_fire_done
        lda     #$E0
        sta     ent_y_spawn_px,y
        lda     #$A8
        sta     ent_spawn_flags,y
        ldx     temp_01
        lda     blocky_fire_timer,x
        sta     ent_drop_flag,y
        ldx     current_entity_slot
        txa
        sta     ent_despawn,y
        dec     temp_01
        bpl     blocky_spawn_fire
blocky_fire_done:  ldx     current_entity_slot
blocky_check_state:  lda     ent_parent_slot,x
        cmp     #$04
        bne     blocky_fire_physics
        sec
        lda     ent_y_px,x
        sbc     #$20
        sta     ent_y_px,x
...
blocky_walk:  lda     #$07
        ...
        adc     ent_x_px,x
        sta     ent_x_px,x
blocky_store_screen:  lda     ent_x_screen,x
        adc     #$00
        sta     ent_x_screen,x
blocky_collision:  jsr     check_vert_tile_collision
        lda     ent_anim_id,x
        cmp     #$0C
        bne     blocky_check_hit
        lda     #$00
        sta     ent_anim_id,x
blocky_check_hit:  jsr     apply_entity_physics
        bcs     blocky_rts
        lda     ent_hit_count,x
        beq     blocky_rts
        lda     #$0D
        ...
        lda     #$02
        sta     temp_01
blocky_spawn_debris:  lda     #ENTITY_MECHA_FIRE     ; spawn fireball (reused as debris)
        jsr     spawn_entity_from_parent
        bcs     blocky_debris_done
        ldx     temp_01
        clc
        lda     ent_y_spawn_px,y
        adc     blocky_debris_y_off,x
        sta     ent_y_spawn_px,y
        lda     blocky_debris_vel_hi,x
        sta     ent_hitbox_w_lo,y
        lda     blocky_debris_vel_lo,x
        sta     ent_hitbox_w_hi,y
        lda     #$04
        sta     ent_hitbox_h_lo,y
        lda     #$00
        ...
        lda     #$FF
        sta     ent_despawn,y
blocky_debris_loop_end:  ldx     current_entity_slot
        dec     temp_01
        bpl     blocky_spawn_debris
blocky_debris_done:  ldx     current_entity_slot
        lda     #$8F
        sta     ent_flags,x
blocky_rts:  rts

blocky_debris_y_off:  .byte   $F0,$10,$20 ; Blocky debris Y offset
blocky_debris_vel_hi:  .byte   $03,$02,$01 ; debris X velocity (high byte)
blocky_debris_vel_lo:  .byte   $00,$40,$00 ; debris X velocity (low byte)
blocky_fire_timer:  .byte   $01,$06,$0B ; fire attack cooldown timers

; ─── Guts-Dozer child AI — track parent boss entity ───
guts_tank_child_ai:  ldy     ent_state,x
        lda     ent_flags,y
...
; ─── Blocky phase-2 AI (type $32) — stacked-block segment ───
blocky_phase2_ai:  ldy     ent_parent_slot,x
        bpl     blocky_phase2_check_timer
        lda     #$07
        sta     temp_01
        lda     #$08
        sta     temp_02
        jsr     check_horiz_tile_collision
        lda     temp_00
        beq     blocky_phase2_physics
        lda     ent_state,x
        beq     blocky_phase2_stop_movement
        lda     #$00
        sta     death_context
        jmp     apply_collision_physics

; =============================================================================
; blocky_phase2_stop_movement -- Blocky Phase 2 AI (entity $32) — bounce, shot spawn ($AA0C)
; Spawns entity $35 (projectile, shared type with Neo Metall bullet).
; =============================================================================
blocky_phase2_stop_movement:  lda     #$00
        sta     ent_x_vel_sub,x
        sta     ent_x_vel,x
        sta     ent_y_vel_sub,x
        lda     #$02
        sta     ent_y_vel,x
        inc     ent_state,x
        bne     blocky_phase2_physics
blocky_phase2_check_timer:  lda     ent_state,x
        beq     blocky_phase2_check_player
        ...
        lda     #$04
        sta     ent_y_vel,x
blocky_phase2_check_player:  lda     ent_y_px,x
        cmp     ent_y_px,y
        bcs     blocky_phase2_physics
        clc
...
blocky_phase2_physics:  jsr     apply_entity_physics
        rts

; ─── Mecha fireball AI (type $33) — Blocky phase shots / Picopico in Wily 3 ───
mecha_fire_ai:  lda     current_stage           ; Wily 3 → Picopico-kun variant
        cmp     #$0A
        bne     blocky_phase2_begin_hitbox
        jmp     picopico_wily3_entry  ; alternate AI for Wily 3
blocky_phase2_begin_hitbox:
        ldy     #$08
        lda     ent_anim_id,x
        cmp     #$03
        bcc     blocky_phase2_set_hitbox
        ldy     #$10
blocky_phase2_set_hitbox:  sty     temp_02
        lda     #$07
        sta     temp_01
        jsr     check_horiz_tile_collision
        lda     ent_parent_slot,x
        bne     blocky_phase2_state_1
        jsr     entity_face_player
        lda     temp_00
        cmp     #$40
        bcs     blocky_phase2_clear_anim
        lda     ent_state,x
        bne     blocky_phase2_dec_main_timer
        inc     ent_anim_id,x
        inc     ent_parent_slot,x
        lda     ent_flags,x
        and     #$F7
        ...
        lda     #$3E
        sta     ent_state,x
        bne     blocky_phase2_jmp_physics
blocky_phase2_dec_main_timer:  dec     ent_state,x
blocky_phase2_clear_anim:  lda     #$00
        sta     ent_anim_frame,x
        sta     ent_anim_id,x
blocky_phase2_jmp_physics:  jmp     blocky_phase2_apply_physics

blocky_phase2_state_1:  cmp     #$02
        bcs     blocky_phase2_state_2_timer
        lda     ent_anim_id,x
        cmp     #$02
...
blocky_phase2_spawn_shot:  lda     #ENTITY_GENERIC_PROJ
        ...
        bcs     blocky_phase2_advance_state
        ldx     temp_01
        lda     blocky_phase2_shot_vel_y_sub,x
        sta     ent_hitbox_h_hi,y
        lda     blocky_phase2_shot_vel_y_hi,x
        sta     ent_hitbox_h_lo,y
        lda     blocky_phase2_shot_vel_x_sub,x
        sta     ent_hitbox_w_hi,y
        lda     blocky_phase2_shot_vel_x_hi,x
        sta     ent_hitbox_w_lo,y
        ldx     current_entity_slot
        dec     temp_01
        bpl     blocky_phase2_spawn_shot
blocky_phase2_advance_state:  lda     #$03
        sta     ent_anim_id,x
        sec
        lda     ent_y_px,x
        sbc     #$08
        sta     ent_y_px,x
blocky_phase2_dec_timer:  dec     ent_state,x
        bne     blocky_phase2_check_anim
        jsr     entity_face_player
        lda     #$02
        sta     ent_x_vel,x
        lda     #$14
        ...
        inc     ent_parent_slot,x
        bne     blocky_phase2_check_anim
blocky_phase2_state_2_timer:  dec     ent_state,x
        bne     blocky_phase2_check_anim
        lda     #$00
        sta     ent_x_vel,x
        sta     ent_anim_id,x
        ...
        and     #$03
        tay
        lda     blocky_phase2_random_timer,y
        sta     ent_state,x
        lda     ent_flags,x
        ora     #$08
        sta     ent_flags,x
blocky_phase2_check_anim:  lda     ent_anim_id,x
        cmp     #$05
        bne     blocky_phase2_apply_physics
        lda     #$03
        sta     ent_anim_id,x
blocky_phase2_apply_physics:  jsr     apply_entity_physics
        rts

blocky_phase2_random_timer:  .byte   $1F,$3E,$9B,$1F
blocky_phase2_shot_vel_y_sub:  .byte   $25,$00,$DB ; Blocky Phase 2 shot Y velocity (sub-pixel)
blocky_phase2_shot_vel_y_hi:  .byte   $01,$00,$FE
blocky_phase2_shot_vel_x_sub:  .byte   $A3,$00,$A3 ; Blocky Phase 2 shot X velocity (sub-pixel)
blocky_phase2_shot_vel_x_hi:  .byte   $01,$02,$01
; ─── Picopico-kun Wily 3 alternate AI entry ───
picopico_wily3_entry:
        lda     ent_state,x
        bne     picopico_wily3_collision
        lda     ent_y_px,x
        cmp     #$80
        bcc     picopico_wily3_check_anim
        inc     ent_state,x
        lda     #$03
        sta     ent_y_vel,x
picopico_wily3_collision:  lda     #$08
        sta     temp_01
        lda     #$10
        sta     temp_02
        jsr     check_vert_tile_collision
        lda     temp_00
        beq     picopico_wily3_check_anim
        lda     #$FF
        sta     ent_y_vel,x
        lda     #$01
        sta     ent_x_vel,x
        ...
        sta     ent_y_vel_sub,x
        sta     ent_x_vel_sub,x
picopico_wily3_check_anim:  lda     ent_anim_id,x
        cmp     #$05
        bne     picopico_wily3_physics
        lda     #$03
        sta     ent_anim_id,x
picopico_wily3_physics:  jsr     apply_entity_physics
        rts
...
; =============================================================================
; pipi_spawn_init -- Pipi Spawner AI (entity $37) — spawn timer and bird init ($ABB1)
; =============================================================================
pipi_spawn_init:  lda     ent_x_px
        sta     ent_x_px,x
        lda     ent_x_screen
        sta     ent_x_screen,x
        lda     ent_state,x
        bne     pipi_spawn_dec_timer
        lda     #$BB
        sta     ent_state,x
        lda     #$01
        sta     temp_01
        ...
        lda     ent_flags
        and     #$40
        bne     pipi_spawn_set_direction
        inx
pipi_spawn_set_direction:  lda     pipi_spawn_dir_flags_table,x
        sta     ent_spawn_flags,y
        clc
        lda     scroll_x
        adc     pipi_spawn_x_offset_table,x
        sta     ent_x_spawn_px,y
        lda     nametable_select
        adc     #$00
        sta     ent_x_spawn_scr,y
pipi_spawn_dec_timer:  ldx     current_entity_slot
        dec     ent_state,x
        rts

pipi_spawn_x_offset_table:  .byte   $F8,$08 ; Pipi spawn X offset per direction
pipi_spawn_dir_flags_table:  .byte   $83,$C3 ; Pipi spawn direction flags
...
pipi_move:  lda     #$87
        ...
        sta     ent_anim_id,x
        sta     ent_anim_frame,x
pipi_anim:  lda     ent_anim_id,x
        cmp     #$03
        bne     pipi_physics
        lda     #$00
        sta     ent_anim_frame,x
pipi_physics:  jsr     apply_entity_physics
        bcc     pipi_rts
        ldy     ent_parent_slot,x
        dey
        lda     #$00
...
; =============================================================================
; pipi_egg_hatch -- Pipi Egg Hatch — spawn Copipi debris ring ($ACB6)
; =============================================================================
pipi_egg_hatch:  lda     #ENTITY_EGG_HATCH      ; spawn explosion flash effect
        jsr     spawn_entity_from_parent
        ...
        lda     #$07
        sta     temp_01
pipi_egg_spawn_loop:  lda     #ENTITY_COPIPI         ; spawn explosion debris
        jsr     spawn_entity_from_parent ; spawn debris piece
        bcs     pipi_egg_deactivate
        ldx     temp_01
        lda     pipi_egg_flags_table,x
        sta     ent_spawn_flags,y
        lda     pipi_egg_vel_y_sub,x
        sta     ent_hitbox_h_hi,y
        lda     pipi_egg_vel_y_hi,x
        sta     ent_hitbox_h_lo,y
        lda     pipi_egg_vel_x_sub,x
        sta     ent_hitbox_w_hi,y
        lda     pipi_egg_vel_x_hi,x
        sta     ent_hitbox_w_lo,y
        lda     pipi_egg_timer_table,x
        sta     ent_drop_flag,y
        ldx     current_entity_slot
        dec     temp_01
        bpl     pipi_egg_spawn_loop
pipi_egg_deactivate:  lsr     ent_flags,x
        rts

pipi_egg_flags_table:  .byte   $C3,$C3,$C3,$C3,$C3,$83,$83,$83 ; explosion entity flags per slot
pipi_egg_vel_y_sub:  .byte   $96,$7B,$1E,$6A,$F0,$00,$E6,$9E ; explosion Y velocity (sub-pixel)
pipi_egg_vel_y_hi:  .byte   $FE,$00,$01,$01,$01,$02,$01,$00
pipi_egg_vel_x_sub:  .byte   $6A,$F0,$A8,$6A,$7B,$00,$9E,$E6 ; explosion X velocity (sub-pixel)
pipi_egg_vel_x_hi:  .byte   $01,$01,$01,$01,$00,$00,$00,$01
pipi_egg_timer_table:  .byte   $0B,$21,$1C,$0B,$21,$10,$19,$19
...
kaminari_cloud_ai:
        ldy     ent_parent_slot,x
        lda     ent_flags,y
        bpl     kaminari_cloud_deactivate
        lda     ent_type,y
        cmp     #$3E
        bne     kaminari_cloud_deactivate
        sec
        lda     ent_y_px,y
        sbc     #$14
        sta     ent_y_px,x
        ...
        sta     ent_anim_frame,x
        sta     ent_state,x
kaminari_cloud_anim_check:
        lda     ent_anim_id,x
        cmp     #$02
        bne     kaminari_cloud_physics
        lda     #$00
        sta     ent_anim_id,x
kaminari_cloud_physics:
        jsr     apply_entity_physics
        rts

kaminari_cloud_deactivate:
        lsr     ent_flags,x
        rts
...
goblin_horn_check_deactivate:
        ...
        inc     ent_parent_slot,x
        bne     goblin_horn_dec_timer
goblin_horn_deactivate:  lsr     ent_flags,x
        rts

goblin_horn_dec_timer:  dec     ent_state,x
        jsr     apply_entity_physics
        rts
...
petit_goblin_ai:
        lda     ent_parent_slot,x
        cmp     #$02
        bne     petit_goblin_active
        jmp     telly_ai
petit_goblin_active:
        lda     ent_state,x
        bne     petit_goblin_dec_timer
        lda     ent_parent_slot,x
        bne     petit_goblin_advance
        lda     #$1A
        sta     ent_state,x
        lda     #$00
        sta     ent_x_vel,x
        ...
        inc     ent_parent_slot,x
        bne     petit_goblin_dec_timer
petit_goblin_advance:  inc     ent_parent_slot,x
        rts

petit_goblin_dec_timer:  dec     ent_state,x
        jsr     apply_entity_physics
        rts

; =============================================================================
; springer_ai -- Enemy AI: Springer — walk, tile-check, jump attack ($B01B)
; =============================================================================
springer_ai:
        lda     ent_parent_slot,x
        beq     springer_tile_check
        jmp     springer_anim
...
springer_tile_check:
        ...
        lda     ent_flags,x
        and     #$40
        bne     springer_calc_tile
        iny
springer_calc_tile:  clc
        lda     ent_x_px,x
        adc     springer_x_offset_table,y
        sta     jump_ptr
        lda     ent_x_screen,x
        adc     springer_x_page_table,y
        sta     jump_ptr_hi
        clc
        lda     ent_y_px,x
        adc     #$09
        ...
        ldx     current_entity_slot
        lda     temp_00
        beq     springer_set_speed
springer_flip:  lda     ent_flags,x
        eor     #$40                    ; flip facing direction
        sta     ent_flags,x
springer_set_speed:  lda     #$00
        sta     ent_x_vel,x
        lda     #$41
        sta     ent_x_vel_sub,x
        sec
        lda     ent_y_px
        sbc     ent_y_px,x
        bcs     springer_check_dist
        eor     #$FF
        adc     #$01
springer_check_dist:  cmp     #$05
        bcs     springer_resume
        lda     #$00
        sta     ent_x_vel_sub,x
        lda     #$02
...
springer_anim:  lda     ent_anim_id,x
        cmp     #$05
        bne     springer_set_speed_val
        lda     #$01
        sta     ent_anim_id,x
springer_set_speed_val:  lda     #$09
        sta     ent_screen_x,x
        dec     ent_state,x
        bne     springer_physics
        dec     ent_parent_slot,x
        lda     #$00
        sta     ent_anim_id,x
        clc
        ...
        adc     #$08
        sta     ent_y_px,x
springer_physics:  jsr     apply_entity_physics_alt
        rts

springer_x_offset_table:  .byte   $08,$F8 ; Springer X check offset
springer_x_page_table:  .byte   $00,$FF

; ─── Mole controller AI (type $47) — tracks player, spawns shot columns ───
mole_ai:  lda     ent_x_vel_sub,x
        bne     mole_track_player
        lda     #ENTITY_MOLE            ; only one controller may be active
        jsr     check_entity_collision_scan
        bcc     mole_track_player
        rts

mole_track_player:  lda     ent_x_px
        sta     ent_x_px,x
        lda     ent_x_screen
        sta     ent_x_screen,x
        lda     ent_state,x
...
; ─── Mole shot AI: upward variant (type $48) ───
mole_shot_up_ai:  lda     #$00
        sta     temp_01
        sec
        lda     ent_y_px,x
        sbc     #$0C
        jmp     mole_shot_store_a

; ─── Mole shot AI: downward variant (type $49) ───
mole_shot_dn_ai:  lda     #$04
        sta     temp_01
        clc
        lda     ent_y_px,x
        adc     #$0C
mole_shot_store_a:  sta     temp_0A
        lda     #$00
        sta     temp_0B
        lda     ent_x_px,x
        sta     jump_ptr
        ...
        ldx     current_entity_slot
        lda     ent_parent_slot,x
        bne     mole_shot_timer_check
        lda     temp_00
        bne     mole_shot_physics
        ldy     temp_01
        lda     mole_shot_vel_fwd,y
        sta     ent_y_vel_sub,x
        lda     mole_shot_vel_hi_fwd,y
        sta     ent_y_vel,x
        inc     ent_parent_slot,x
        lda     #$4B
        sta     ent_state,x
        bne     mole_shot_physics
mole_shot_timer_check:  ldy     temp_01
        lda     ent_state,x
        beq     mole_shot_reverse
        dec     ent_state,x
        bne     mole_shot_wall_check
mole_shot_reverse:  lda     mole_shot_vel_rev,y
        sta     ent_y_vel_sub,x
        lda     mole_shot_vel_hi_rev,y
        sta     ent_y_vel,x
mole_shot_wall_check:  lda     temp_00
        beq     mole_shot_physics
        lda     mole_shot_vel_fwd,y
        sta     ent_y_vel_sub,x
        lda     mole_shot_vel_hi_fwd,y
        sta     ent_y_vel,x
mole_shot_physics:  jsr     apply_entity_physics
        rts

mole_shot_vel_fwd:  .byte   $41
mole_shot_vel_rev:  .byte   $E5
mole_shot_vel_hi_fwd:  .byte   $00
mole_shot_vel_hi_rev:  .byte   $00
...
crazy_cannon_ai:
        lda     ent_parent_slot,x
        beq     crazy_cannon_init
        lda     ent_anim_id,x
        cmp     #$05
        bne     crazy_cannon_jmp
        lda     #$00
        sta     ent_anim_frame,x
        lda     ent_state,x
        bne     cannon_dec_timer
        lda     #$00
        sta     temp_01
        jsr     cannon_fire_shot
        dec     ent_x_vel_sub,x
        beq     crazy_cannon_dec
        lda     #$1F
        sta     ent_state,x
        bne     cannon_dec_timer
crazy_cannon_dec:
...
crazy_cannon_init:
        ...
        lda     ent_x_vel_sub,x
        cmp     #$06
        bne     cannon_set_timer
        inc     ent_parent_slot,x
        bne     cannon_physics

; =============================================================================
; cannon_set_timer -- Boss Projectile Manager — timer-based firing with RNG ($B266)
; =============================================================================
cannon_set_timer:  lda     #$1F
        sta     ent_state,x
cannon_dec_timer:  dec     ent_state,x
cannon_physics:  jsr     apply_entity_physics_alt
        rts

; ─── Fire projectile with RNG-based angle ───
cannon_fire_shot:  ldx     temp_01
        lda     rng_seed
        and     cannon_fire_rng_mask,x
        clc
        adc     cannon_fire_rng_base,x
        sta     temp_0B
        lda     cannon_fire_rng_divisor,x
        sta     temp_0D
        lda     #$00
        sta     temp_0A
        sta     temp_0C
        ...
        lda     #ENTITY_SHOTMAN
        jsr     spawn_entity_from_parent
        bcs     cannon_fire_done
        ldx     temp_01
        lda     cannon_fire_vel_y_sub,x
        sta     ent_hitbox_h_hi,y
        lda     cannon_fire_vel_y_hi,x
        sta     ent_hitbox_h_lo,y
        lda     temp_0E
        sta     ent_hitbox_w_hi,y
        lda     temp_0F
        ...
        sec
        lda     ent_y_spawn_px,y
        sbc     cannon_fire_y_offset,x
        sta     ent_y_spawn_px,y
        lda     ent_spawn_flags,y
        and     #$40
        bne     cannon_fire_adjust_x
        inx
        inx
cannon_fire_adjust_x:  clc
        lda     ent_x_spawn_px,y
        adc     cannon_fire_x_offset,x
        sta     ent_x_spawn_px,y
        lda     ent_x_spawn_scr,y
        adc     cannon_fire_x_offset_hi,x
        sta     ent_x_spawn_scr,y
cannon_fire_done:  ldx     current_entity_slot
        rts

cannon_fire_rng_mask:  .byte   $23        ; boss fire RNG bitmask
cannon_fire_rng_base:  .byte   $18
cannon_fire_rng_divisor:  .byte   $30
cannon_fire_vel_y_sub:  .byte   $E6
cannon_fire_vel_y_hi:  .byte   $04
cannon_fire_y_offset:  .byte   $0C
cannon_fire_x_offset:  .byte   $0C
cannon_fire_x_offset_hi:  .byte   $00,$F4,$FF,$1F,$60,$18,$D4,$02
        .byte   $00,$08,$00,$F8,$FF  ; unknown data padding
; ─── Sniper Armor AI: jump, land, shoot, spawn Joe ───
sniper_armor_ai:
        lda     ent_parent_slot,x
        bne     sniper_armor_state_check
        lda     ent_state,x
        bne     sniper_armor_anim_check
        lda     ent_anim_id,x
        cmp     #$02
        bne     sniper_armor_alt_physics
        lda     #$87
        sta     ent_flags,x
        jsr     entity_face_player
        lda     #$78
        ...
        inc     ent_parent_slot,x
        bne     sniper_armor_alt_physics
sniper_armor_anim_check:
        lda     ent_anim_id,x
        bne     sniper_armor_dec_main_timer
        sta     ent_anim_frame,x
sniper_armor_dec_main_timer:  dec     ent_state,x

; =============================================================================
; sniper_armor_alt_physics -- Multi-Phase Boss — state machine with timer-based phase changes ($B32D)
; =============================================================================
sniper_armor_alt_physics:  jsr     apply_entity_physics_alt
        bcc     sniper_armor_rts
        jmp     sniper_armor_death_check

sniper_armor_rts:  rts

sniper_armor_jmp_physics:  jmp     sniper_armor_physics

sniper_armor_state_check:
        cmp     #$01
        bne     sniper_armor_state_2
        lda     #$02
        sta     ent_anim_id,x
        lda     ent_y_vel,x
        php
        ...
        jsr     check_horiz_tile_collision
        plp
        bpl     sniper_armor_jmp_physics
        lda     temp_00
        beq     sniper_armor_jmp_physics
        lda     #$21
        jsr     sound_queue_push
        lda     #$03
        sta     ent_anim_id,x
        ...
        sbc     ent_y_px,x
        cmp     #$10
        bne     sniper_armor_dec_timer
        lda     #$12
        sta     ent_state,x
        lda     #$02
        sta     ent_parent_slot,x
        bne     sniper_armor_dec_timer
sniper_armor_state_2:  lda     ent_anim_id,x
        bne     sniper_armor_check_timer
        lda     #$00
        sta     ent_anim_frame,x
sniper_armor_check_timer:  lda     ent_state,x
        bne     sniper_armor_dec_timer
        lda     #$25
        jsr     sound_queue_push
        jsr     entity_face_player
        ...
        jsr     spawn_entity_from_parent
        bcs     sniper_armor_check_cycle
        lda     ent_parent_slot,x
        tax
        lda     sniper_armor_shot_vel_y_sub,x
        sta     ent_hitbox_h_hi,y
        lda     sniper_armor_shot_vel_y_hi,x
        sta     ent_hitbox_h_lo,y
        lda     sniper_armor_shot_vel_x_sub,x
        sta     ent_hitbox_w_hi,y
        lda     sniper_armor_shot_vel_x_hi,x
        sta     ent_hitbox_w_lo,y
sniper_armor_check_cycle:  txa
        ldx     current_entity_slot
        cmp     #$06
        bne     sniper_armor_short_timer
        lda     #$00
        sta     ent_parent_slot,x
        lda     #$3F
        sta     ent_state,x
        bne     sniper_armor_dec_timer
sniper_armor_short_timer:  lda     #$12
        sta     ent_state,x
        inc     ent_parent_slot,x
sniper_armor_dec_timer:  dec     ent_state,x
sniper_armor_physics:  jsr     apply_entity_physics
        bcc     sniper_armor_rts_2
        jmp     sniper_armor_death_check

sniper_armor_rts_2:  rts

sniper_armor_death_check:  lda     ent_hp,x
        bne     sniper_armor_rts_2
        lda     #ENTITY_SNIPER_JOE
        jsr     spawn_entity_from_parent
        bcs     sniper_armor_rts_2
        lda     #$7E
        .byte   $99,$F0           ; STA $04F0,Y (hi byte overlaps table below)
sniper_armor_shot_vel_y_sub:  .byte   $04,$60,$6A,$A0,$88 ; vel Y sub table (also STA hi byte + RTS)
sniper_armor_shot_vel_y_hi:  .byte   $12,$58,$FB,$FC,$FD
sniper_armor_shot_vel_x_sub:  .byte   $FE,$FF,$8C,$4E,$9A ; multi-boss shot X velocity table
sniper_armor_shot_vel_x_hi:  .byte   $C2,$D2,$06,$07,$07,$07,$07
...
press_retract_ai:
        dec     ent_state,x
        beq     press_retract_deactivate
        jsr     apply_entity_physics_alt
        rts
press_retract_deactivate:
        lsr     ent_flags,x
        rts
...
appear_block_a_ai:
        lda     #$7D
        bne     appear_block_store_timer
appear_block_b_ai:
        lda     #$BB
        bne     appear_block_store_timer
appear_block_c_ai:
        lda     #$FA
appear_block_store_timer:
        sta     temp_00
        lda     ent_parent_slot,x
        bne     appear_block_phase_1
        lda     temp_00
        sta     ent_plat_y,x
        inc     ent_parent_slot,x
        bne     appear_block_dec_timer
appear_block_phase_1:  cmp     #$01
        bne     appear_block_phase_2
        lda     ent_plat_y,x
        bne     appear_block_dec_timer
        lda     #$90
        sta     ent_flags,x
        ...
        sta     ent_anim_frame,x
        sta     ent_anim_id,x
        beq     appear_block_dec_timer
appear_block_phase_2:  lda     ent_anim_id,x
        cmp     #$05
        bne     appear_block_phase_3
        lda     #$00
        sta     ent_anim_frame,x
appear_block_phase_3:  lda     #$01
        sta     ent_state,x
        lda     ent_x_px,x
        and     ent_x_vel,x
        sta     ent_y_vel,x
        ...
        sta     ent_plat_y,x
        dec     ent_parent_slot,x
appear_block_dec_timer:  dec     ent_plat_y,x
        jsr     apply_entity_physics_alt
        rts
...
gutsdozer_turret_ai:
        lda     ent_state,x
        bne     gutsdozer_turret_set_movement
        lda     #$80
        sta     ent_y_vel_sub,x
        lda     #$FF
        sta     ent_y_vel,x
        lda     ent_y_px,x
        cmp     #$7F
        bcc     gutsdozer_turret_jmp_shared
        bcs     gutsdozer_turret_stop_vel
gutsdozer_turret_set_movement:
        lda     #$80
        sta     ent_y_vel_sub,x
        lda     #$00
        sta     ent_y_vel,x
        lda     ent_y_px,x
        cmp     #$68
        bcs     gutsdozer_turret_jmp_shared
gutsdozer_turret_stop_vel:
        lda     #$00
        sta     ent_y_vel,x
        sta     ent_y_vel_sub,x

; =============================================================================
; gutsdozer_turret_jmp_shared -- Guts-Dozer Turret (entity $69) — shared velocity jump ($BA2F)
; =============================================================================
gutsdozer_turret_jmp_shared:  jmp     wily4_shared_velocity

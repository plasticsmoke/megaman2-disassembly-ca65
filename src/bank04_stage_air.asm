...
; =============================================================================
; Bank $04 — Air Man Stage (tiles, stage $01)
; Tile patterns, metatile definitions, screen layouts, and room data.
; Entity spawn tables serve Quick Man (stage $04) + Wily 5 (stage $0C) via AND #$07.
; =============================================================================
...
; =============================================================================
; CHR Tile Pattern Data ($8000-$8080)
; =============================================================================
; Air Man stage graphics loaded into CHR-RAM via DMA.
        .byte   $00
...
; =============================================================================
; Metatile Definitions, Screen Layouts, and Room Data ($8081+)
; =============================================================================
; Metatile combinations, per-screen grids, scroll config, and palette indices.
        ...
        .byte   $FF,$00,$55,$FF,$FF,$FF,$FF,$00
        .byte   $FF,$FF,$AA,$00,$00,$00,$00,$FF
        .byte   $AA,$00,$00,$AA,$FF
        .byte   $FF,$00,$00,$55,$FF,$FF,$FF
        .byte   $FF,$FF,$00,$00,$FF,$00,$55,$FF
        .byte   $FF,$FF,$FF,$00,$FF,$FF,$AA,$00
        .byte   $00,$00,$00,$FF,$AA,$00,$00,$AA
        .byte   $FF,$FF,$00
        .byte   $00,$55,$FF,$FF,$FF,$FF,$FF,$00
        .byte   $D0,$D0,$D7,$D0
        .byte   $F0,$D7
        .byte   $F0,$F0
        .byte   $B0,$B7
...
; =============================================================================
; Entity Spawn Tables — Quick Man ($04) + Wily 5 ($0C)
...
; =============================================================================
; BG Palette Data — Quick Man (stage $04)
